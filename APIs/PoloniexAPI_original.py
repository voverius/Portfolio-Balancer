...
class Poloniex:
    def __init__(self, APIKey='', Secret=''):
        ...
        # PUBLIC COMMANDS
        self.marketTicker = lambda x=0: self.api('returnTicker')      # V
        self.marketVolume = lambda x=0: self.api('return24hVolume')   # V
        self.marketStatus = lambda x=0: self.api('returnCurrencies')  # V
