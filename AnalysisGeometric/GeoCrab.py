...
def GeoCrab(diff, err_allowed=0.1):
    ...
    ABrange2 = np.array([0.618 - 0.618 * err_allowed, 0.618 + 0.618 * err_allowed]) * abs(diff[0])
    ...
    CDrange1 = np.array([2.240 - 2.240 * err_allowed, 2.240 + 2.240 * err_allowed]) * abs(diff[2])
    CDrange2 = np.array([3.618 - 3.618 * err_allowed, 3.618 + 3.618 * err_allowed]) * abs(diff[2])
    XDrange = np.array([1.618 - 1.618 * err_allowed, 1.618 + 1.618 * err_allowed]) * abs(diff[0])
